const Produtos=()=>{
  ...
  <div>
    <img alt="Camisa de time" />
    <h3>Camisa de time</h3>
    <p>
      Camisa extremamente leve , para praticar esportes e estar
      na moda com seu time preferido
    </p>
  </div>
</section>
